...
public class TemplateTest extends BaseTemplatePatternTest {
  ...
  /**
   * Tests the 'lambda way' {@link EvaluationProcessLambda}.
   */
  public void engineerEvaluationProcessLambda() {
    ...
    evaluationProcess(new EvaluationProcessLambda(ProcessEvaluationAlgorithms::engineer), ProcessEvaluationAlgorithms::engineer);
  }
  ...
  public void managerEvaluationProcessLambda() {
    /* No subclass, move from polymorphism to composition by passing the appropriate lambda at the constructor */
    evaluationProcess(new EvaluationProcessLambda(ProcessEvaluationAlgorithms::management), ProcessEvaluationAlgorithms::management);
  }
